...
namespace Assignment_IPL.Services
{
    public class Query
    {
        ...
        public List<Player> SerachPlayer(string name)
        {
        ...
        public List<Player> GetBowlers(string name)
        {
        ...
        public List<Player> GetHighestWicketTakerAndScorer(string name)
        {
            int highest_score = 0;
        ...
        public void Show11BestBatsmanMatchStatistics()
        {
            int score;
            double max_avg1 = 0;
            double max_avg2 = 0;
            ...
            Console.WriteLine($"The Team1:{team1.GetName()} will score {(int)max_avg1 * 11} is the predicted score");
            Console.WriteLine($"The Team2:{team2.GetName()} will score {(int)max_avg2 * 11} is the predicted score");
        ...
        public void FindNextGen()
        {
            foreach (var team_ in teams)
            {
                ...
                Console.WriteLine(@$"team name: {t_name}-----------------------------------");
                foreach (var p in players_)
                {
                    Console.WriteLine(p);
                }
